...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        configServidor = findViewById(R.id.btn_conectar);

    }

    public  void onClickSelecionarServidor(View view){
        Intent intent = new Intent(this, ConfigServidor.class);
